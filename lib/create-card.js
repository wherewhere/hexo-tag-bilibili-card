 ...
 */
function createCard(imageProxy, { vid, type, title, author, cover, duration, views, danmakus, comments, favorites, coins, likes}) {
 ...
 * @param {{warn: function(string): void}} log
 */
module.exports = (imageProxy, id, log = console) => getVideoMessage(id, log).then(x => createCard(imageProxy, x));
